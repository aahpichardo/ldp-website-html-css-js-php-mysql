                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>Sumérjase en la opulencia mientras experimenta un servicio excepcional y comodidades de clase mundial. Cada detalle ha sido cuidadosamente diseñado para ofrecerle una experiencia inolvidable.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <p>Desde nuestras lujosas habitaciones hasta nuestras exquisitas opciones gastronómicas, en el Luna de Plata nos esforzamos por superar todas sus expectativas. Permita que nosotros le brindemos un refugio de distinción y sofisticación durante su estancia.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>Descubre el pináculo del entretenimiento en nuestro hotel de lujo. Disfruta de "Los Mejores Espectáculos", una experiencia única donde la magia y la elegancia se encuentran. Desde actuaciones teatrales hasta conciertos en vivo, cada momento es una obra maestra de entretenimiento exclusivo.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-body" style="background-color: #96d1fb;">
            <div class="section3">
                    ...
                    <form method="post" id="formulario-reservacion" onsubmit="" action="php/guardar_reservacion.php">
                        ...
                        <button type="submit" id="boton-reservacion" class="btn btn-primary">Reservar</button>
                    </form>
            </div>
        </div>
      </div>
